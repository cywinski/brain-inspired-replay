...
def set_defaults(args, only_MNIST=False, single_task=False, generative=True, compare_code='None', **kwargs):
    ...
    if not single_task:
        ...
        args.iters = (5000 if args.experiment in {'CIFAR100', "CIFAR10"} else 2000) if args.iters is None else args.iters
    ...
    if not single_task and not compare_code in ('hyper', 'bir'):
        ...
        elif args.experiment in{'CIFAR100', "CIFAR10"}:
